...
export const PORTAL_VOZ_MODE_QUESTIONS = {
  ...
  'claro-directo': [
    ...
    'util-hoy': [
  'Cuando la pienso con calma, la obra se siente distinta.',
  'Salí del teatro y sentí que la obra no había terminado.',
  'Siento que Silvestre no está mal solo por él… hay algo más.',
  'Me quedé con algo atorado después de verla.',
  ...
  'Siento que empieza algo y no termina.',
