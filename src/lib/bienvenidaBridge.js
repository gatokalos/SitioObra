export const BIENVENIDA_APP_TO_SHOWCASE = {
  ...
  'miniverso-novela': 'miniversoNovela',
  'miniverso-la-novela': 'miniversoNovela',
  'miniverso-la-literatura': 'miniversoNovela',
  ...
  'miniverso-graficos': 'miniversoGrafico',
  'miniverso-lo-grafico': 'miniversoGrafico',
  'miniverso-los-graficos': 'miniversoGrafico',
  ...
  'miniverso-lo-sonoro': 'miniversoSonoro',
  'miniverso-las-sonoridades': 'miniversoSonoro',
  movimiento: 'miniversoMovimiento',
  danza: 'miniversoMovimiento',
  ruta: 'miniversoMovimiento',
  'app-movimiento': 'miniversoMovimiento',
  'miniverso-movimiento': 'miniversoMovimiento',
  'miniverso-el-movimiento': 'miniversoMovimiento',
  artesanias: 'lataza',
  artesania: 'lataza',
  taza: 'lataza',
  merch: 'lataza',
  'la-taza': 'lataza',
  'miniverso-artesanias': 'lataza',
  'miniverso-la-taza': 'lataza',
  'miniverso-las-artesanias': 'lataza',
  cine: 'copycats',
  video: 'copycats',
  copycats: 'copycats',
  quiron: 'copycats',
  'app-cine': 'copycats',
  'miniverso-el-cine': 'copycats',
