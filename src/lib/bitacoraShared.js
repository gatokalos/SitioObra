...
export const CATALOG = [
  ...
  { key: 'juegos',      name: 'Juegos',         showcase: 'apps',                color: 'text-yellow-300',  q: '¿Qué cambia en ti cuando una historia depende de las decisiones de otros?',      cta: 'Sigue el riesgo' },
