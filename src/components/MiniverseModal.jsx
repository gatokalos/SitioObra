...
export const MINIVERSE_CARDS = [
  ...
  },
  {
    ...
    narrativeVideoUrl: null,
    narrativeVideoUrlDesktop: null,
    narrativeCtaLabel: 'Seguir la escritura',
    ctaVerb: 'Lee',
    action: 'Explora',
    isPremium: true,
  },
  {
    ...
    narrativeVideoUrl: null,
    narrativeVideoUrlDesktop: null,
    narrativeCtaLabel: 'Seguir al objeto',
    ctaVerb: 'Sostén',
    action: 'Explora',
  },
  {
    ...
    description: 'Luego me vi dibujando y no supe si estaba creando... o si algo dentro me estaba dibujando a mí.',
    videoUrl: null,
    narrativeVideoUrl: null,
    narrativeVideoUrlDesktop: null,
    narrativeCtaLabel: 'Seguir la imagen',
    ctaVerb: 'Mira',
    action: 'Explora',
  },
  {
  ...
  },
  {
    ...
    description: 'Entonces entendí: todo esto había empezado sin mí.',
    videoUrl: null,
    narrativeVideoUrl: null,
    narrativeVideoUrlDesktop: null,
  ...
  },
  {
    ...
    description: 'Toqué fondo. No había enseñanza. Solo vértigo.',
    videoUrl: null,
    narrativeVideoUrl: null,
    narrativeVideoUrlDesktop: null,
    narrativeCtaLabel: 'Seguir el cuerpo',
    ctaVerb: 'Siente',
    action: 'Explora',
  },
  {
    ...
    description: 'Convertí el riesgo en preguntas. Dejé que otros eligieran qué responder.',
    videoUrl: null,
    narrativeVideoUrl: null,
    narrativeVideoUrlDesktop: null,
    narrativeCtaLabel: 'Seguir el riesgo',
    ctaVerb: 'Elige',
    action: 'Explora',
  },
  {
    ...
    glassTint: '266 62% 60%',
    title: '09 - La pregunta',
    titleShort: '🎧 "La revelación" (30 seg)',
    description: 'Tal vez esto nunca fue una obra. Tal vez fue un sueño compartido en nueve vidas.',
    videoUrl: null,
    narrativeVideoUrl: null,
    narrativeVideoUrlDesktop: null,
    narrativeCtaLabel: 'Seguir la pregunta',
    ctaVerb: 'Consulta',
    action: 'Explora',
  },
...
export const IncendioVideoPlaceholder = ({ compact = false }) => (
  <div
...
const MiniverseModal = ({
  ...
  const [isBienvenidaIframeOpen, setIsBienvenidaIframeOpen] = useState(false);
    ...
    const handleMessage = (event) => {
      if (event.data?.type === 'bienvenida:gatokens-update') {
        ...
        if (typeof value === 'number' && value > 0) {
          ...
          setIsBienvenidaIframeOpen(false);
        }
      }
    };
  ...
  const bienvenidaGuardrailOverlay = typeof document !== 'undefined'
    ? createPortal(
      <AnimatePresence>
        {open && user && !hasBienvenida && !isBienvenidaIframeOpen ? (
          <motion.div
            key="habitar-guardrail-overlay"
          ...
          >
            <div className="flex flex-col items-center gap-6 px-8 text-center max-w-xs sm:max-w-sm">
              ...
              <div className="space-y-2">
                <h3 className="font-display text-xl text-slate-100 sm:text-2xl leading-tight">
                  Primero, vive la bienvenida
                </h3>
                <p className="text-sm leading-relaxed text-slate-300/80">
                  Los miniversos se abren cuando ya has cruzado la puerta de entrada al universo. La bienvenida es ese primer umbral.
                </p>
              </div>
              <button
                type="button"
                onClick={() => setIsBienvenidaIframeOpen(true)}
  ...
  const bienvenidaIframeOverlay = typeof document !== 'undefined'
    ? createPortal(
      <AnimatePresence>
        {isBienvenidaIframeOpen ? (
          <motion.div
            key="miniverse-bienvenida-iframe"
          ...
          >
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              onClick={() => setIsBienvenidaIframeOpen(false)}
            />
            <motion.div
              role="dialog"
              aria-modal="true"
