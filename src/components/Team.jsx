...
const teamData = {
   ...
   Dirección: {
    ...
    bio: "Comunicólogo, autor y artista transmedia. Su obra habita entre teatro, escritura y tecnología, proponiendo una poética crítica y humana. Formado en el ITESO, la Universidad de Salamanca e ICONOS Ciudad de México; integra estudios en astrología psicológica (Centre for Psychological Astrology), trabajo corporal (Core Energetics) y arte digital (LABASAD Barcelona) en una mirada simbólica. Autor del universo transmedia #GatoEncerrado, concibe el acto creativo como una forma de acompañamiento y transformación.",
