...
const Hero = () => {
  ...
  return <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      <div className="absolute inset-0 bg-black">
        ...
        <img className="absolute inset-0 w-full h-full object-cover opacity-10 mix-blend-luminosity" alt="Textura de telón de teatro de terciopelo oscuro" src="https://horizons-cdn.hostinger.com/97df2709-6244-412e-9fc4-b6382e776f4d/logo-by-enigma-gekDc.png" />
      </div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        ease: "easeOut"
          ...
          duration: 1.5,
          delay: 0.2
        }} className="font-display text-5xl md:text-7xl font-medium italic mb-6 text-gradient" style={{
          textShadow: '0 0 20px rgba(233, 213, 255, 0.3)'
        }}>
            #GatoEncerrado
          </motion.h1>
