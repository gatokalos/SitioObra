          ...
          <div>
            ...
            >
              ...
              <ul className="space-y-3">
                {[{name: 'Transmedia', href: '#transmedia'}, { name: 'Alianza', href: '#apoya' }, {name: 'Obra', href: '#about'}, {name: 'Equipo', href: '#team'}, {name: 'Galería', href: '#instagram'}, { name: 'Voces', href: '#provoca' }, { name: 'Curaduría', href: '#dialogo-critico' }, {name: 'Funciones', href: '#next-show'}, { name: 'Contacto', href: '#contact' }].map((item) => (
                  <li key={item.name}>
                    <button
