          ...
          <div>
            ...
            >
              ...
              <ul className="space-y-3">
                {[{name: 'La Obra', href: '#about'}, {name: 'Equipo', href: '#team'}, {name: 'Universo', href: '#transmedia'}, {name: 'Galería', href: '#instagram'}, {name: 'Función', href: '#next-show'}].map((item) => (
                  <li key={item.name}>
                    <button
          ...
          <div>
            ...
            >
              ...
              <ul className="space-y-3 text-sm font-light">
                <li className="text-slate-400">info@gatoencerrado.com</li>
