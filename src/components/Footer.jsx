          ...
          <div>
            ...
            >
              ...
              <ul className="space-y-3">
                {[{name: 'Obra', href: '#about'}, {name: 'Equipo', href: '#team'}, {name: 'Galería', href: '#instagram'}, {name: 'Función', href: '#next-show'}, { name: 'Textos', href: '#dialogo-critico' }, {name: 'Miniversos', href: '#transmedia'}, { name: 'Causa', href: '#apoya' }].map((item) => (
                  <li key={item.name}>
                    <button
